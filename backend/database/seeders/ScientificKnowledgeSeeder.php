...
class ScientificKnowledgeSeeder extends Seeder
{
    ...
    private function seedSources(): array
    {
        $definitions = [
            ...
            'natural_2010' => [
                'title' => 'Sustainable Management of Moko and Bugtok Diseases of Banana',
                'authors' => 'Marina P. Natural', 'year' => 2010, 'journal_or_institution' => 'University of the Philippines Los Baños',
                'source_type' => 'university_extension', 'volume' => null, 'issue' => null, 'pages' => null, 'doi' => null,
                'reference_url' => 'https://www.ukdr.uplb.edu.ph/professorial_lectures/930/', 'country_or_region' => 'Philippines',
                'peer_reviewed' => false, 'philippines_specific' => true, 'publication_date' => '2010-09-10',
                'notes' => 'UPLB professorial chair lecture reporting Philippine Moko/Bugtok transmission and management research.',
            ],
            'ilagan_2010' => [
                'title' => 'Direct Detection of Race 2 Ralstonia solanacearum (Smith) Yabuuchi in Banana Fruit Stalk Using Polymerase Chain Reaction',
                'authors' => 'Ma. Fatima C. Ilagan; Maria Teresa M. Perez; Asuncion K. Raymundo',
                'year' => 2010, 'journal_or_institution' => 'The Philippine Agricultural Scientist', 'source_type' => 'peer_reviewed_article',
                'volume' => '93', 'issue' => '3', 'pages' => '307-316', 'doi' => null,
                'reference_url' => 'https://www.ukdr.uplb.edu.ph/journal-articles/2480/', 'country_or_region' => 'Philippines',
                'peer_reviewed' => true, 'philippines_specific' => true, 'publication_date' => null,
                'notes' => 'PCR study in putative Moko/Bugtok samples; supports confirmation and warns that morphology-only diagnosis can be wrong.',
            ],
            'pcaarrd_2017' => [
            ...
            'molina_2006' => [
                'title' => 'Managing bacterial wilt/fruit rot disease of banana in Southeast Asia',
                'authors' => 'Agustin B. Molina', 'year' => 2006, 'journal_or_institution' => 'Bioversity International / regional workshop proceedings',
                'source_type' => 'academic_book_chapter', 'volume' => null, 'issue' => null, 'pages' => null, 'doi' => null,
                'reference_url' => 'https://www.musalit.org/viewPdf.php?file=IN060593_eng.pdf&id=10013', 'country_or_region' => 'Southeast Asia, including the Philippines',
                'peer_reviewed' => false, 'philippines_specific' => true, 'publication_date' => null,
                'notes' => 'Regional technical account of Moko/Bugtok symptoms, transmission pathways, sanitation, clean planting material, debudding, and bagging.',
            ],
            'mendoza_2019' => [
            ...
            'rincon_florez_2024' => [
                'title' => 'Validation of PCR Diagnostic Assays for Detection and Identification of All Ralstonia solanacearum Sequevars Causing Moko Disease in Banana',
                'authors' => 'Vivian A. Rincón-Flórez; Lilia C. Carvalhais; Adriano M. F. Silva; Alistair McTaggart; Jane D. Ray; Cecilia O’Dwyer; Janet M. Roberts; Elineide B. Souza; Greecy M. R. Albuquerque; André Drenth',
                'year' => 2024, 'journal_or_institution' => 'Phytopathology', 'source_type' => 'peer_reviewed_article',
                'volume' => '114', 'issue' => '11', 'pages' => null, 'doi' => '10.1094/PHYTO-06-24-0190-R',
                'reference_url' => 'https://apsjournals.apsnet.org/doi/10.1094/PHYTO-06-24-0190-R', 'country_or_region' => 'International, including Philippine occurrence',
                'peer_reviewed' => true, 'philippines_specific' => false, 'publication_date' => '2024-11-23',
                'notes' => 'Validated molecular assays and current taxonomic context for Moko-causing Ralstonia solanacearum sensu stricto sequevars.',
            ],
            'fpa_registered_2026' => [
    ...
    private function diseases(): array
    {
        return [
            ...
            [
                'slug' => 'moko-disease', 'model_class_key' => 'moko-disease', 'name' => 'Moko Disease', 'alternative_names' => ['Moko bacterial wilt', 'Banana Moko disease'],
                'scientific_name' => 'Ralstonia solanacearum species complex, Moko ecotype', 'causal_agent' => 'Ralstonia solanacearum species complex, Moko ecotype', 'pathogen_type' => 'bacterium',
                'short_description' => 'Serious bacterial disease that may cause yellowing and wilting',
                'farmer_summary' => 'Moko is a serious bacterial disease that affects the banana plant internally. It can interfere with water-conducting tissues, causing yellowing, wilting, poor growth, and eventual plant decline.',
                'curative_status' => 'no_known_cure', 'evidence_level' => 'high',
                'image_only_limitations' => 'Moko cannot be reliably confirmed from a leaf photograph alone. Internal pseudostem or fruit symptoms and laboratory or expert assessment may be needed.',
                'professional_referral' => 'Seek agricultural assessment promptly if Moko is suspected so containment and plant-removal decisions can be planned safely.',
                'description' => 'Possible Moko disease. Leaf symptoms alone are not enough to confirm this systemic bacterial disease.',
                'management' => 'Prioritize containment, sanitation, clean planting material, and early professional assessment rather than a home chemical cure.',
                'prevention' => 'Use disease-free planting material, disinfect cutting tools, and avoid moving from a suspect plant to healthy plants with the same unclean tool.',
                'symptom_records' => [
                    ['stage' => 'early', 'plant_part' => 'leaves', 'symptom' => 'Yellowing and collapse may begin in younger leaves.', 'visible_in_leaf_image' => true, 'farmer_friendly_text' => 'Younger leaves may yellow, wilt, or collapse.', 'sort_order' => 1],
                    ['stage' => 'advanced', 'plant_part' => 'leaves', 'symptom' => 'Older leaves may subsequently yellow and collapse as wilt progresses.', 'visible_in_leaf_image' => true, 'farmer_friendly_text' => 'Wilting and yellowing may spread to older leaves.', 'sort_order' => 2],
                    ['stage' => 'typical', 'plant_part' => 'pseudostem', 'symptom' => 'Internal vascular tissues can become discolored and necrotic.', 'visible_in_leaf_image' => false, 'farmer_friendly_text' => 'Internal pseudostem tissue may show discoloration.', 'sort_order' => 3],
                    ['stage' => 'advanced', 'plant_part' => 'fruit', 'symptom' => 'Advanced infection may cause internal fruit discoloration or rot symptoms.', 'visible_in_leaf_image' => false, 'farmer_friendly_text' => 'Fruit may show unusual internal discoloration.', 'sort_order' => 4],
                ],
                'management_records' => [
                    ['category' => 'sanitation', 'recommendation' => 'Disinfect tools used for desuckering, debudding, or deleafing between plants.', 'farmer_friendly_text' => 'Keep cutting and pruning tools clean and disinfected between plants.', 'evidence_strength' => 'high', 'requires_professional' => false, 'regulatory_check_required' => false, 'regulatory_checked_at' => null, 'sort_order' => 1],
                    ['category' => 'resistant_material', 'recommendation' => 'Use verified disease-free planting material.', 'farmer_friendly_text' => 'Avoid planting material taken from diseased or suspect plants.', 'evidence_strength' => 'high', 'requires_professional' => false, 'regulatory_check_required' => false, 'regulatory_checked_at' => null, 'sort_order' => 2],
                    ['category' => 'containment', 'recommendation' => 'Detect suspect infections early and arrange controlled destruction or removal of infected plants and mats.', 'farmer_friendly_text' => 'Do not continue routine cutting from a suspect plant to healthy plants; arrange early assessment and containment.', 'evidence_strength' => 'high', 'requires_professional' => true, 'regulatory_check_required' => false, 'regulatory_checked_at' => null, 'sort_order' => 3],
                    ['category' => 'prevention', 'recommendation' => 'For insect-transmitted Bugtok-type risk, protect flowers through timely bagging and remove male buds at the appropriate stage.', 'farmer_friendly_text' => 'For cooking bananas where Bugtok is a concern, ask an agriculturist about timely flower bagging and debudding.', 'evidence_strength' => 'moderate', 'requires_professional' => true, 'regulatory_check_required' => false, 'regulatory_checked_at' => null, 'sort_order' => 4],
                    ['category' => 'expert_referral', 'recommendation' => 'Use expert inspection and pathogen-specific testing where confirmation is necessary.', 'farmer_friendly_text' => 'Have a suspect plant assessed promptly; a leaf photo alone cannot confirm Moko.', 'evidence_strength' => 'high', 'requires_professional' => true, 'regulatory_check_required' => false, 'regulatory_checked_at' => null, 'sort_order' => 5],
                ],
                'evidence' => [
                    ['source' => 'rincon_florez_2024', 'claim_type' => 'causal_agent', 'claim_text' => 'Moko disease is caused by strains within Ralstonia solanacearum sensu stricto, with multiple Moko-associated sequevars.', 'evidence_strength' => 'high'],
                    ['source' => 'ilagan_2010', 'claim_type' => 'differential_diagnosis', 'claim_text' => 'PCR detected the pathogen in 73% of putative Moko/Bugtok samples, and the authors identified morphology-only misdiagnosis as a possible explanation for negative samples.', 'evidence_strength' => 'high'],
                    ['source' => 'molina_2006', 'claim_type' => 'symptom', 'claim_text' => 'Philippine Moko accounts describe younger-leaf yellowing and collapse, vascular discoloration, and fruit involvement.', 'evidence_strength' => 'moderate'],
                    ['source' => 'natural_2010', 'claim_type' => 'transmission', 'claim_text' => 'Contaminated cutting tools and, for Bugtok-type disease, flower-visiting insects are important transmission pathways.', 'evidence_strength' => 'high'],
                    ['source' => 'natural_2010', 'claim_type' => 'management', 'claim_text' => 'Disease-free planting materials, tool disinfection, sanitation, early detection, and swift destruction of infected plants or mats are recommended.', 'evidence_strength' => 'high'],
                    ['source' => 'pcaarrd_2017', 'claim_type' => 'philippine_relevance', 'claim_text' => 'Moko affects Philippine banana systems, including Region XII, and was reduced under a GAP intervention.', 'evidence_strength' => 'moderate'],
                    ['source' => 'natural_2010', 'claim_type' => 'curative_status', 'claim_text' => 'Management focuses on prevention, sanitation, containment, and removal rather than restoration of a systemically infected plant.', 'evidence_strength' => 'high'],
                ],
            ],
            [
