...
- Complete expert label, species, visibility/quality, inclusion, near-duplicate, and biological/acquisition group review. The August 26 formal gate scanned 13,415 files and admitted 12,670 active readable files plus 745 quarantine files, but found 1,011 unresolved near-duplicate pairs and 12,670 incomplete active metadata records.
