...
export const CLASS_DISPLAY_NAMES: Record<ClassKey, string> = { healthy: 'Healthy', sigatoka: 'Black Sigatoka', 'panama-disease': 'Panama Disease', 'cordana-leaf-spot': 'Cordana' };
